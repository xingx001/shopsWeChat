      ...
      <View className='interests-wrap'>
        ...
        </View>
        {
          ...
          <View className=" interests-content">
            ...
            <View className="interests-input">
              <Textarea value={item.ccontent} onInput={(e)=>this.onChangeInput(e,'ccontent',index)}  placeholder='请输入会员权益具体内容' placeholderClass="placeholderClass" />
            </View>
          </View>
          <View><Text onClick={()=>this.onDelete(index)}>删除</Text></View>
        </View>
          ))
        }
