...
export default class DateTimePicker extends Component<any,any> {
                    ...
                    <View className="model-box">
                        <View className="model-picker">
                            <View className="button-model">
                                <Text className="btn-txt" onClick={this.cancelHandel}>取消</Text>
                                <Text className="btn-txt" onClick={this.okHandel}>确定</Text>
                            </View>
